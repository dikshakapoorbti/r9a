...
const App = () => {
  ...
  // ✅ CHANGED: Renamed from isDocumentsOpen to isOthersOpen
          ...
          <div className="hidden md:flex space-x-8 items-center">
            ...
            >
              ...
              >
                ...
                <ChevronDown 
                  size={16} 
                  className={`transform transition-transform ${isOthersOpen ? 'rotate-180' : ''}`}
                />
              </button>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200 py-4">
            <div className="flex flex-col space-y-2">
              ...
              {/* ✅ NEW: "Others" Dropdown for Mobile */}
              <div>
                <button
              ...
              {/* ✅ END: "Others" Dropdown for Mobile */}
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          console.log("Error submitting form inside try:", data);
          alert("Failed to send message. Please try again.");
        }
      } catch (error) {
        console.error("Error submitting form inside catch:", error);
